window.onload = function() {
  ...
  function mouseCapture() {
    ...
    document.getElementById("moveMe").style.left = (mouse_offset_x - mBox.width / 2) + 10 + "px";
    document.getElementById("moveMe").style.top = (mouse_offset_y - mBox.height / 2) + 10 + "px";
  }
}
